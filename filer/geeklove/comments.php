        ...
        <div id="comment-wrap">
            <div class="inner-block">
                ...
                <h3 id="comments"><?php comments_number(__('0 Comments', 'stag'), __('1 Comment', 'stag'), __('% Comments', 'stag')); ?></h3>
                    <a href="#respond" class="button" hidden>
  ...
  $aria_req = ( $req ? " aria-required='true'" : '' );
      $fields = array(
              ...
              'fields' => apply_filters( 'comment_form_default_fields', array(
                  ...
                  'email' => '<p class="comment-form-email"><label for="email">' . __( 'Your Email', 'stag' ) . '</label><input required id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" /></p>',
                   ) )
      );
